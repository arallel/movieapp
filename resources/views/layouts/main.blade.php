...
<body class="font-sans bg-gray-900 text-white">
       <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row  items-center justify-between px-4 py-5">
         ...
         <div class="flex flex-col md:flex-row items-center">
         	...
         	<div class="md:ml-4 mt-3 md:mt-0">
               <a href="#">
                <img src="{{ asset('user.png')}}" alt="avatar" class="rounded-full w-8 h-8">
               </a>
           </div>
         </div>
        </div>
