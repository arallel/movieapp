...
<div class="movie-info border-b border-gray-800">
  <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
  	<img src="{{ $movie['poster_path']}}" alt="joker" class="w-64 md:w-96">
  	<div class="md:ml-24">
...
<div class="movie-cast border-b border-gray-800">
	<div class="container mx-auto px-4 py-16">
		 ...
		 @foreach($movie['cast'] as $cast)
			<div class="mt-8">
				...
				<img src="{{'https://image.tmdb.org/t/p/w300/'.$cast['profile_path']}}" alt="joker" class="hover:opacity-75 transition ease-in-out duration-150">
				</a>
				<div class="mt-2 text-sm mt-1">
					<div class="mt-2">
	...
	<div class="container mx-auto px-4 py-16">
		 <h2 class="text-4xl font-semibold">Movie Galery</h2>
		 <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3
		 lg:grid-cols-4 gap-8">
